...
int main(int argc, char *argv[]) {
    ...
    color_set(&Red, 0.9, 0.2, 0.2, 1);
    color_set(&Blue, 0.2, 0.25, 0.8, 1);
    ...
    // point light 1
    point_set3D(&lightLoc, 4.0, 3.0, 4.0);
    lighting_add( light, LightPoint, &PointColor, NULL, &lightLoc, 0, 0 );
    
    point_set3D(&lightLoc, 0.0, -2.0, 7.0);
    ...
    image_write(src, "proj2scene1.ppm");
    system("convert proj2scene1.ppm proj2scene1.png");
    system("open proj2scene1.png");
